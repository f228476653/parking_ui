# ngx-charts (f.k.a. ng2d3)
 this component was folked from swimlane's ngx-charts project,7.0.3. we had customized and extended some new features to fit our requirements.
 To find original document, please see below. thanks.
