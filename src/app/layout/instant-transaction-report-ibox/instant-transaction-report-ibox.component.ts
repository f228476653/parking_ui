...
@Component({
  selector: 'app-instant-transaction-report-ibox',
  templateUrl: './instant-transaction-report-ibox.component.html',
  styleUrls: ['./instant-transaction-report-ibox.component.css'],
})

export class InstantTransactionReportIboxComponent implements OnInit {
  ...
  this.excel_data = [];
    ...
    this.excelService.exportAsExcelFile(this.excel_data, 'instant_transaction_ibox');
  }
}
